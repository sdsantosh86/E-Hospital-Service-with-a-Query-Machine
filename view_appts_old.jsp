<%-- 
    Document   : view_appts_old
    Created on : 18 Mar, 2017, 2:40:24 PM
    Author     : charwitha999
--%>
    ...
    <div class="wrapper">
        <div class="table">
            ...
            <% 
                ...
                ResultSet appts = st.executeQuery("select app_date,pname,p_phone,puser,status from appts where doctor='"+dname+"' AND status='"+sts+"' order by app_date desc");
                            while(appts.next())
                            {
                               %>
                                <div class="row">
